...
/**
 * Excepción personalizada para operaciones relacionadas con recetas.
 * 
 * @author Edgar Islas
 * @version 1.0
 */
public class RecipeException extends RuntimeException {
     ...
     * @param cause Causa del error
     */
    public RecipeException(String message, String errorCode, Throwable cause) {
        super(message, cause);
        this.errorCode = errorCode;
    }
